                        ...
                        <div id="receipt-data">
                            <div>
                                ...
                                <table class="table table-striped table-condensed">
                                    <thead>
                                        <tr>
                                            <th class="text-center" style="width: 30%; border-bottom: 2px solid #ddd;"><?=lang('date');?></th>
                                            <th class="text-center" style="width: 40%; border-bottom: 2px solid #ddd;"><?=lang('customer');?></th>
                                            <th class="text-center" style="width: 15%; border-bottom: 2px solid #ddd;">Tipo de pago</th>
                                            <th class="text-center" style="width: 15%; border-bottom: 2px solid #ddd;">Monto</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                      <?php foreach($payments as $payment): ?>
                                        <tr>
                                            ...
                                            <td><?= $this->tec->formatMoney($payment->amount) ?></td>
                                        </tr>
                                      <?php endforeach; ?>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            <th colspan="3" class="text-right">Efectivo:</th>
                                            <th class="text-right"><?= $this->tec->formatMoney($total->cash); ?> </th>
                                        </tr>
                                        <tr>
                                            <th colspan="3" class="text-right">Transferencia:</th>
                                            <th class="text-right"><?= $this->tec->formatMoney($total->transfer); ?> </th>
                                        </tr>
                                    </tfoot>
                                </table>

                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $asp = [0 => lang('disable'), 1 => lang('enable')]; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $asp = [0 => lang('receipt'), 1 => lang('pos')]; ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    $dprv = ['1' => lang('name'), '2' => lang('photo'), '3' => lang('both')];
                                    ...
                                    <div class="">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php $yn = [0 => lang('text'), 1 => lang('image')]; ?>
